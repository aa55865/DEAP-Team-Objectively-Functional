...
mod.sketches['__profile__'].autoTrimCurve(curve1=
    mod.sketches['__profile__'].geometry[4], point1=(tuple(n.divide(tuple(n.add(bl_corner, tl_corner)), (2, 2)))))
mod.sketches['__profile__'].autoTrimCurve(curve1=
    mod.sketches['__profile__'].geometry[14], point1=(tuple(n.divide(tuple(n.add(bl_corner, tl_corner)), (2, 2)))))
mod.sketches['__profile__'].autoTrimCurve(curve1=
    mod.sketches['__profile__'].geometry[13], point1=(tuple(n.divide(tuple(n.add(br_corner, tr_corner)), (2, 2)))))
mod.sketches['__profile__'].autoTrimCurve(curve1=
    mod.sketches['__profile__'].geometry[16], point1=(tuple(n.divide(tuple(n.add(br_corner, tr_corner)), (2, 2)))))
